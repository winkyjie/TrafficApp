...
package cn.fszt.trafficapp.widget.msg;
...
public class AppMsg {
    ...
    public static final int LENGTH_VERYLONG = 6000;
    ...
    public static final Style STYLE_INFO_LONG = new Style(LENGTH_VERYLONG, R.color.info);
    
    public static final Style STYLE_ALERT_LONG = new Style(LENGTH_VERYLONG, R.color.alert);
