...
//			this.setBackgroundResource(R.drawable.bl_record2);
			this.setText("松开结束");
			this.setBackgroundColor(getResources().getColor(R.color.orange_bg));
			break;
		case MotionEvent.ACTION_UP:
			finishRecord();
//			this.setBackgroundResource(R.drawable.bl_record);
			this.setText("按住说话");
			this.setBackgroundColor(getResources().getColor(R.color.titlebar));
			break;
...
//			this.setBackgroundResource(R.drawable.bl_record);
	...
	private void finishRecord() {
		...
		if (intervalTime < MIN_INTERVAL_TIME) {
			Toast.makeText(getContext(), getResources().getString(R.string.ra_tooshort), Toast.LENGTH_SHORT).show();
	...
	private void cancelRecord() {
		...
		Toast.makeText(getContext(), getResources().getString(R.string.ra_cancel), Toast.LENGTH_SHORT).show();
		File file = new File(mFileName);
		file.delete();
	}
