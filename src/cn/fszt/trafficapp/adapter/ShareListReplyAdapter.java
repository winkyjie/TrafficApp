 ...
 *
 */
public class ShareListReplyAdapter extends BaseAdapter {
	
	private LayoutInflater inflater; // 视图容器
	private List<ReplydetailData> replydetailList;
	...
	public ShareListReplyAdapter(){
		
	}
	
	public ShareListReplyAdapter(Context context,String zhengze,int densityDpi) {
	...
	public void setReplydetailList(List<BaoliaoAndBaoguangData> arrays,int position){
