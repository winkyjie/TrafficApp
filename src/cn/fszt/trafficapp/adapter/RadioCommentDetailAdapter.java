 ...
 *
 */
public class RadioCommentDetailAdapter extends BaseAdapter {
	...
	public RadioCommentDetailAdapter(Context mContext, List<RadioCommentDetailReplyData> arrays,LayoutInflater inflater,int densityDpi,String delbgpl_url,String uid){
...
//		this.reportypl_url = reportypl_url;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final String hdcommentreplyid = arrays.get(position).getHdcommentreplyid();
...
//		}
		...
		case 1:
        	...
        	bgplholder.btn_bgdetail_deldetail.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					dialog(hdcommentreplyid, position);
				}
			});
	...
	Handler handler = new Handler(){
		...
		private void dialog(final String hdcommentreplyid,final int position){
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					new Thread(){
						public void run() {
							...
							String resultString = HttpUtil.GetStringFromUrl(delbgpl_url+"&hdcommentreplyid="+hdcommentreplyid);
							try {
