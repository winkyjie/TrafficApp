 ...
 *
 */
public class SpActAdapter extends BaseAdapter {
	private Context mContext;
	private List<CarlifeAndHuodongData> arrays;
	private LayoutInflater inflater;
	private String delcarlifeandhuodong_url,s_hdinfocommentid,uid;
	...
	public SpActAdapter(Context mContext, List<CarlifeAndHuodongData> arrays,LayoutInflater inflater,String delcarlifeandhuodong_url,String uid,int densityDpi){
	...
	Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				mgr.deleteS_carlifeByhdinfocommentid(s_hdinfocommentid);
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					new Thread(){
						public void run() {
							...
							String resultString = HttpUtil.GetStringFromUrl(delcarlifeandhuodong_url+hdinfocommentid);
							try {
