...
public class SpCarlifeActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sql_arrays = mgr.queryS_carlifeByConnected_uid(uid+"");
		...
		if(sql_arrays.size()==0){  //当数据库没有数据时，从网络更新并插入数据库
	       	initArrays(new Handler(){
	           	...
	           	public void handleMessage(Message msg) {
	           		...
	           		adapter = new SpActAdapter(SpCarlifeActivity.this,arrays,inflater,delmpl_url,uid,densityDpi);
	                listView.setAdapter(adapter);
	           		adapter.notifyDataSetChanged();
	           		pullDownView.notifyDidDataLoad(false);
	           		
	           		if(arrays!=null){
	           			mgr.addS_carlife(arrays);
	   		...
	   		initArrays(new Handler(){
	           	...
	           	public void handleMessage(Message msg) {
	           		...
	           		if(arrays==null){  //网络更新失败时，还是显示数据库的历史数据
	           			...
	           			mgr.deleteS_carlifeByconnected_uid(uid+"");
						mgr.addS_carlife(arrays);
						pb_carlife.setVisibility(View.GONE);
	           		}
	           		adapter = new SpActAdapter(SpCarlifeActivity.this,arrays,inflater,delmpl_url,uid,densityDpi);
	...
	private void initView() {
    	...
    	space_carlife_url = getResources().getString(R.string.server_url)+getResources().getString(R.string.space_carlife_url);
