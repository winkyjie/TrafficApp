 ...
 *
 */
public class ActListActivity extends BaseBackActivity implements
		OnItemClickListener {
	...
	private String searchparam = "all"; // 判断筛选的文章类别all 全部文章,hdvote 有投票的文章,
										// hdactivity 有报名的文章
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		contenttype = intent_type.getStringExtra("contenttype");
		push = intent_type.getStringExtra("push");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			if (push != null && "true".equals(push)) {
				Intent intent = new Intent(ActListActivity.this,
						MainFragment.class);
		...
		case R.id.item_hd_tonews:
			Intent intent = new Intent(this, NewsListActivity.class);
			startActivity(intent);
			break;

		case R.id.item_hd_vote:
			searchparam = "hdvote";
			getActionBar().setTitle(
					getResources().getString(R.string.item_hd_vote));
			searchBySearchparam();
			break;

		case R.id.item_hd_baoming:
			searchparam = "hdactivity";
			getActionBar().setTitle(
					getResources().getString(R.string.item_hd_baoming));
			searchBySearchparam();
			break;

		case R.id.item_hd_all:
			searchparam = "all";
			getActionBar().setTitle(
					getResources().getString(R.string.n_qingbao));
			searchBySearchparam();
		...
		case R.id.item_hd_general:
			searchparam = "general";
			getActionBar().setTitle(
					getResources().getString(R.string.item_hd_general));
			searchBySearchparam();
			break;

		case R.id.item_hd_important:
			searchparam = "important";
			getActionBar().setTitle(
					getResources().getString(R.string.item_hd_important));
			searchBySearchparam();
			break;
