...
public class AsynImageLoaderLis {
	...
	public AsynImageLoaderLis(){
		// 初始化变量
		caches = new HashMap<String, SoftReference<Bitmap>>();
		taskQueue = new ArrayList<AsynImageLoaderLis.Task>();
		// 启动图片下载线程
		isRunning = true;
	...
	public interface OnLoadImageListener{
		...
		void onLoadDone(String msg);
	}
	
	private OnLoadImageListener onLoadImageListener;
	
	public void setOnLoadImageListener(
	...
	{
		onLoadImageListener.onLoadDone(msg);
	}
